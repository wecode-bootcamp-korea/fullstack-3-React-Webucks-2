...
function Detail() {
	...
	return (
		<div className='Detail'>
			...
			<section>
				<aside>
					<img alt='토피 넛 라떼' src={process.env.PUBLIC_URL + '/images/french.jpg'} />
				</aside>
				<main>
					...
					<div onSubmit={submitCommnet}>
						<form className='review'>
							...
							<input type='input' className='reviewInput' placeholder='리뷰를 입력해주세요' value={comment} onChange={saveComment} />
						</form>
					</div>
				</main>
			</section>
